...
public class View extends JFrame {
    ...
    public void setStartGame() {
        getCmbCategory().setEnabled(false);
        getBtnNew().setEnabled(false);
        getTxtChar().setEnabled(true);
    ...
    public boolean setEndGame() {
        getCmbCategory().setEnabled(true);
        getBtnNew().setEnabled(true);
        getTxtChar().setEnabled(false);
        ...
        getLblError().setForeground(Color.BLACK);
        return false;
    }
